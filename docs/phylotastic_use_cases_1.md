...
*   **1\. Gather species names**. The list of species is scraped from a web page or, alternatively, the list is generated by expanding a taxon name into its component species.
*   **2\. Clean species names**. No special conditions or exceptions.
